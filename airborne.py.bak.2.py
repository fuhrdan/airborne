...
bullets = []
fire_delay = 200  # 0.2 second delay between shots
...
def fire_bullet():
    ...
    if current_time - last_shot_time >= fire_delay:
        ...
        if gun_mode == 'air' and mouse_y > HEIGHT - 40:
            dy = HEIGHT - 60 - turret_y  # Ensure air bullets do not go below 30 pixels above ground
...
def draw_helicopter(x, y):
    ...
    if helicopter_frame % 2 == 0:
        pygame.draw.line(screen, BLUE, (x + 5, y - 5), (x + 35, y - 5), 2)  # Rotor blades frame 1
    else:
        pygame.draw.line(screen, BLUE, (x + 10, y - 7), (x + 30, y - 3), 2)  # Rotor blades frame 2
    pygame.draw.rect(screen, BLUE, (x + 5, y + 5, 30, 5))  # Tail
    helicopter_frame += 1

def draw_tank(x, y):
    pygame.draw.rect(screen, GREEN, (x, y, 40, 20))  # Tank body
    pygame.draw.rect(screen, BLACK, (x + 15, y - 10, 10, 10))  # Turret
    pygame.draw.circle(screen, BLACK, (x + 5, y + 20), 5)  # Left wheel
    pygame.draw.circle(screen, BLACK, (x + 35, y + 20), 5)  # Right wheel

def draw_jet(x, y):
    pygame.draw.polygon(screen, BLACK, [(x, y), (x + 40, y + 10), (x, y + 20), (x - 10, y + 10)])  # Jet shape
...
def main():
    ...
    while running:
        ...
        draw_tank(200, HEIGHT - 30)
        draw_jet(WIDTH - 100, 50)
